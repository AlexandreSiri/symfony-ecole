...
class __TwigTemplate_11c54636765454a43dcd1e2ff6c12752a2cc4be69f291cdb45428a2f92192e5b extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "roles", [], "any", false, false, false, 13), 'row');
        echo "
...
";
    ...
    {
        return array (  111 => 15,  106 => 13,  102 => 12,  98 => 11,  94 => 10,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t</div>
{% endblock %}
", "admin/user.edit.html.twig", "/mnt/c/Users/alexs/Desktop/php-symfony-school-main/templates/admin/user.edit.html.twig");
    }
}
