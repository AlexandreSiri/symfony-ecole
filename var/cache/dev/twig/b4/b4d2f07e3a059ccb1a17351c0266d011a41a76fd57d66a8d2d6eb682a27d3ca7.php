...
class __TwigTemplate_b8ad649f2a1ff73970b0cd19995921dd4b339925e358d27ff4b3b94db8f9d8b2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  105 => 16,  99 => 13,  95 => 12,  91 => 10,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t<h4>Connexion</h4>
        <p>Vous n'avez pas de compte ? <a href=\"{{ path(\"register\") }}\">Créez-en un</a></p>
\t\t<form action=\"{{ path('login') }}\" method=\"post\">
            <div>
                <label for=\"email\">Email:</label>
                <input type=\"email\" id=\"email\" name=\"_username\" value=\"{{ last_email }}\"/>
            </div>
            <div>
                <label for=\"password\">Password:</label>
                <input type=\"password\" id=\"password\" name=\"_password\"/>
...
\t</div>
{% endblock %}
", "auth/login.html.twig", "/mnt/c/Users/alexs/Desktop/php-symfony-school-main/templates/auth/login.html.twig");
    }
}
